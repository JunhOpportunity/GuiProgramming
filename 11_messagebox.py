...
# 메세지 박스는 show 에는 info, warning, error 세 개가 존재
#  ask 에는 okcancel, retrycancel 등
...
def warn():
    msgbox.showwarning("경고", "해당 좌석은 매진되었습니다") # 앞에 쓴 게 메세지 박스의 제목

def error():
    msgbox.showerror("에러", "결제 오류가 발생했습니다") # 앞에 쓴 게 메세지 박스의 제목
